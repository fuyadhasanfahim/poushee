...
const base =
  "font-body inline-flex items-center justify-center gap-2 rounded-full font-medium tracking-tight transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed";
...
const variants: Record<Variant, string> = {
  ...
  ghost:
    "border border-navy-800/25 bg-white/70 text-navy-900 backdrop-blur-md hover:bg-white hover:border-navy-800/45",
  "ghost-light":
